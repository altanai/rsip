use rsip::{
    ...
    headers::typed::{authorization::Tokenizer, Authorization, ProxyAuthorization},
};
use std::convert::TryInto;

validate_typed_header_trait!(ProxyAuthorization);
...
mod try_from_tokenizer {
    ...
    fn try_from1() {
        assert_eq!(
            ...
            .try_into(),
            Ok(ProxyAuthorization(Authorization {
